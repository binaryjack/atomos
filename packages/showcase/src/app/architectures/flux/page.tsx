  ...
  return (
    <div className="flex flex-col gap-10 w-full h-full pb-10">
      <header className="border-b border-slate-800 pb-8 shrink-0">
        <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 mb-4">FLUX Diagram</h1>
        <p className="text-slate-400 leading-relaxed text-lg">Unidirectional data flow paradigm for UI applications.</p>
      </header>
